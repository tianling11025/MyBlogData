...
对于没有服务器的朋友，首先要做的就是购买一台云服务器，可以去[亚马逊](https://aws.amazon.com)，或者[vultr](https://www.vultr.com/)等。

### Install shadowsocks Server（服务端）
...
#### Linux
##### Install
与windows的类似，先安装python以及pip，再通过pip安装shadowsocks.
ubuntu:
```bash
...
*若有疑问，可进群咨询， 群号在个人主页http://home.nmask.cn*
